			...
			<li>
				...
				<div class="collapsible-body">
					<ul>
						...
						<li>
							<a href="daftarperusahaanuser.php" class="waves-effect active" ><i class="material-icons">home</i>PERUSAHAAN ANDA</a>
						</li>
						<li>
							<div class="divider"></div>
						</li>
		...
		<div class="row">
			<div class="col s10 offset-s2">
				<h3 class="welcome-user" style="text-decoration:underline; text-align:center;">
					DAFTAR <span style="color:#004d40;">PERUSAHAAN USER</span>
				</h3>
			</div>
		</div>
		<div class="row">
			<table class="col s10 offset-s2 striped">
				<thead>
					<tr>
						<th data-field="id">NAMA PERUSAHAAN</th>
						<th data-field="name">Nama Pemilik</th>
						<th data-field="id">Bidang Perusahan</th>
				...
				<tbody>
					<tr>
						<td>JOHN CORPORATE</td>
						<td>John'Oconnor</td>
						<td>Telekomunikasi</td>
						<td>
							<a href="editperusahaanuser.php" class="btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="EDIT DATA">
									<i class="material-icons">edit</i>
							</a>
							<a href="#" class="btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="HAPUS DATA">
