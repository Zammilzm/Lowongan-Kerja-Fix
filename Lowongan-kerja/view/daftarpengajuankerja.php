			...
			<li>
				...
				<div class="collapsible-body">
					<ul>
						...
						<li>
							<a href="daftarpengajuankerja.php" class="waves-effect active" ><i class="material-icons">shop</i>DAFTAR PENGAJUAN KERJA</a>
						</li>
					</ul>
				</div>
			</li>
		...
		<div class="row">
			<div class="col s10 offset-s2">
				<h3 class="welcome-user" style="text-decoration:underline; text-align:center;">
					STATUS <span style="color:#004d40;">PENGAJUAN KERJA</span>
				</h3>
			</div>
		</div>
		<div class="row">
