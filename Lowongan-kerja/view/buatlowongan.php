			...
			<li>
				...
				<div class="collapsible-body">
					<ul>
						...
						<li>
							<a href="buatlowongan.php" class="waves-effect active" ><i class="material-icons">work</i>BUAT LOWONGAN</a>
						</li>
						<li>
							<div class="divider"></div>
						</li>
		...
		<div class="row">
			<div class="col s10 offset-s2">
				<h3 class="welcome-user" style="text-decoration:underline; text-align:center;">
					BUAT <span style="color:#004d40;">LOWONGAN</span>
				</h3>
			</div>
		</div>
		<div class="row">
				...
				<div class="row">
					<div class="input-field col s12">
						<select>
							...
							<option value="1">JOHN COMPANY</option>
							<option value="2">JOHN CORPORATE</option>
						</select>
					</div>
				</div>
				<div class="row">
					<p>
						...
						<label for="test5">Sekretris</label>
					</p>
					<p>
						<input type="checkbox" id="test5" />
						<label for="test5">Bendahara</label>
					</p>
					<p>
						<input type="checkbox" id="test5" />
						<label for="test5">Office-Boy</label>
					</p>
					<p>
						<input type="checkbox" id="test5" />
						<label for="test5">Cleaning Service</label>
					</p>
					<p>
						<input type="checkbox" id="test5" />
						<label for="test5">Head-Officer</label>
					</p>
					<p>
						<input type="checkbox" id="test5" />
						<label for="test5">Programer</label>
					</p>
				</div>
			</form>
