...
<body style="background-color:#cfd8dc;">
	...
	<div class="container col-md-10">
		<h2 style="text-align:center; padding:0 0 30px 0; text-decoration:underline;">Daftar Perusahaan LOWONGAN-KERJA.COM</h2>
		<table class="table table-condensed table-hover ">
			<thead>
				<tr>
					...
					<th>Deskripsi Singkat Perusahaan</th>
					<th>Pemilik</th>
					<th>Aksi</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					...
					<td>Jember Kidul no 6</td>
					<td>CV</td>
					<td>Jember</td>
					<td>Perusahaan terbaik dalam hal komunikasi</td>
					<td>Johhny Depp</td>
					<td>
